...
(t=>{const e=document.createElement("style");e.dataset.source="vite-plugin-monkey",e.textContent=t,document.head.append(e)})(' @charset "UTF-8";.box-card .el-card__header[data-v-c229a9d9]{padding:10px 20px}.box-card .el-card__header span[data-v-c229a9d9]{font-size:14px}.setAIBox .el-input__inner{margin-bottom:0;background-color:transparent;border:0;outline:none}.quickReplyBox[data-v-1b723407]{position:relative}.quickReplyBox .el-form[data-v-1b723407]{text-align:left}.quickReplyBox .reply-form-inline .el-form-item[data-v-1b723407]{margin-bottom:15px}.el-dialog__footer a{text-decoration:none}.el-tabs__nav-next,.el-tabs__nav-prev{height:44px;display:flex;justify-content:center;align-items:center}.el-dialog{display:flex;flex-direction:column;margin:0!important;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);max-height:calc(100% - 30px);max-width:1300px}.el-dialog__header{margin-right:0!important}.el-dialog__body{flex:1;overflow:auto;padding:0}.quickReplyBox .el-input__inner{margin-bottom:0;background-color:transparent;border:0;outline:none}#reply-control.open{height:calc(var(--composer-height) + 65px)!important}#reply-control .reply-area{height:calc(100% - 91px)!important}.app-dialog-foot[data-v-1b723407]{color:#909399;font-size:14px}.quickReplyBoxTitle[data-v-1b723407]{margin-right:10px;font-weight:700;color:red}.el-form-item--mini.el-form-item[data-v-1b723407],.el-form-item--small.el-form-item[data-v-1b723407]{margin-bottom:10px}.el-select[data-v-1b723407]{width:300px}.margin-left{margin-left:15px}.login-tabs{margin-bottom:20px}.form-tip{margin-top:5px}.el-dialog__footer{background-color:#fff}.card-header[data-v-31ed8fab]{width:100%}.header-left[data-v-31ed8fab]{display:flex;align-items:center;margin-bottom:10px}.header-left .login-type[data-v-31ed8fab]{margin-left:10px;font-size:14px;color:#409eff}@media (min-width: 768px){.header-left[data-v-31ed8fab]{margin-bottom:0}}.header-right[data-v-31ed8fab]{width:100%}.header-right .button-group[data-v-31ed8fab]{display:flex;flex-wrap:wrap;gap:5px;justify-content:flex-start}@media (min-width: 768px){.header-right .button-group[data-v-31ed8fab]{justify-content:flex-end}}.login-container[data-v-31ed8fab]{padding:20px;background-color:#f9f9f9;border-radius:5px;margin-bottom:20px}.login-container .login-header[data-v-31ed8fab]{display:flex;justify-content:space-between;align-items:center;margin-bottom:15px;padding-bottom:10px;border-bottom:1px solid #ebeef5}.login-container .login-header h3[data-v-31ed8fab]{margin:0;font-size:18px;color:#303133}.settings-container[data-v-31ed8fab]{padding:20px}.settings-header[data-v-31ed8fab]{display:flex;justify-content:space-between;align-items:center;margin-bottom:20px}.my-replies-card[data-v-31ed8fab]{min-height:300px}.my-replies-card .card-title[data-v-31ed8fab]{font-weight:700}.list-left[data-v-31ed8fab]{padding-right:15px;display:flex;flex:1;align-items:stretch;justify-content:start}.list-number[data-v-31ed8fab]{margin-right:5px;color:#909399}.list-title[data-v-31ed8fab]{flex:1;font-weight:400}.list-right[data-v-31ed8fab]{min-width:70px}.list-right .el-badge.item[data-v-31ed8fab]{margin-right:30px}.list li[data-v-31ed8fab]{margin-bottom:5px;padding-bottom:5px;font-size:13px;line-height:30px;display:flex;align-items:flex-start;justify-content:space-between;border-bottom:1px solid #ebeef5}.list li[data-v-31ed8fab]:hover{background-color:#f5f5f5}.tips[data-v-31ed8fab]{margin-left:50px;text-align:left;font-size:12px}.addReplyBox[data-v-31ed8fab]{margin-top:15px;padding-top:10px;border-top:1px dashed #ccc}.box-card .el-card__header[data-v-31ed8fab]{padding:10px 20px}.box-card .el-card__header span[data-v-31ed8fab]{font-size:14px}.clearfix[data-v-31ed8fab]:before,.clearfix[data-v-31ed8fab]:after{display:table;content:""}.clearfix[data-v-31ed8fab]:after{clear:both}.el-pagination[data-v-31ed8fab]{padding:15px 5px 0}.setBox .el-input__inner{margin-bottom:0;background-color:transparent;border:0;outline:none}.setBox .el-checkbox{white-space:wrap}.text-info{color:#909399!important;font-size:13px}.el-button.is-text{padding:0;color:#409eff;background:transparent;border-color:transparent}.el-button.is-text:hover{color:#66b1ff;background-color:transparent;border-color:transparent}.el-button.is-text.is-disabled{color:#c0c4cc}.el-tag--info.el-tag--light{color:#909399;background-color:#f4f4f5;border-color:#e9e9eb}.el-form-item__label{font-weight:400}.el-button--small{padding:5px 11px;font-size:12px}.el-dialog{border-radius:4px;overflow:hidden}.el-card__body{padding:20px}.el-input__inner{line-height:normal}@media (max-width: 767px){.el-button{margin-bottom:5px;margin-right:3px}.el-button--small{padding:4px 8px;font-size:12px}.el-button-group .el-button{margin-right:0}.el-card__header{padding:10px}.el-dialog{width:90%!important;max-width:100%;margin:5vh auto!important}.el-dialog__body{padding:15px 10px}.el-form-item{margin-bottom:15px}.el-form-item__label{padding-bottom:5px}.el-dropdown-menu{min-width:100px}.el-input__inner{height:36px}.el-tabs__item{padding:0 12px}.el-pagination{justify-content:center;padding:15px 0}.el-pagination .el-pager{margin:0 5px}.el-pagination .btn-prev,.el-pagination .btn-next{min-width:24px}}@media (max-width: 480px){.el-pagination{padding:10px 0}.el-pagination button{min-width:24px!important;margin:0 2px!important}.el-pagination .el-pager li{min-width:24px!important;margin:0 2px!important;font-size:12px}}.el-dropdown-menu{min-width:100px}.el-dropdown-menu__item{display:flex;align-items:center;line-height:1.5;padding:8px 16px}.el-dropdown-menu__item .el-icon{margin-right:8px}@media (max-width: 480px){.el-dropdown-menu{min-width:90px}.el-dropdown-menu__item{padding:6px 10px;font-size:13px}}.el-icon-upload:before{content:"\uE602";font-family:element-icons!important}.el-icon-download:before{content:"\uE606";font-family:element-icons!important} ');
...
Tips：使用AI就像开盲盒，请准备好是否接受结果再提交`
                    ...
                    vue.createVNode(_component_el_col, {
                      ...
                      default: vue.withCtx(() => [
                        vue.createElementVNode("div", _hoisted_6, [
                          vue.createVNode(_component_el_row, { gutter: 5 }, {
                            default: vue.withCtx(() => [
                              vue.createVNode(_component_el_col, {
                                xs: 24,
                                sm: 24,
  ...
  const Set = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-31ed8fab"]]);
  const Util = {
    install: (app2, options) => {
