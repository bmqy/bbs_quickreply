...
Tips：使用AI就像开盲盒，请准备好是否接受结果再提交`
  ...
  const _hoisted_5 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ vue.createElementVNode("p", { class: "tips" }, [
    ...
    /* @__PURE__ */ vue.createElementVNode("br"),
    /* @__PURE__ */ vue.createTextVNode(" * 忘记密码可重新注册，或联系作者提供可用邮箱重置密码；"),
    /* @__PURE__ */ vue.createElementVNode("br"),
