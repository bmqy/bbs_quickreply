...
Tips：使用AI就像开盲盒，请准备好是否接受结果再提交`
  ...
  const Set = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-af3466cf"]]);
  const Util = {
    install: (app2, options) => {
