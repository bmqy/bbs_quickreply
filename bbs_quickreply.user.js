...
(function() {
    ...
    function QuickReply(){
        ...
        // 自定义回复内容
        this.replysCustom = (GM_getValue('replysCustom') && GM_getValue('replysCustom').toString().trim() !== '') ? GM_getValue('replysCustom') : this.replysDefault;
    ...
    QuickReply.prototype.getQuickReply = function(){
        ...
        QuickReply.updateReplysSelect(oQuikReplySelect, this.replysCustom);
    ...
    QuickReply.prototype.init = function(){
        ...
        if(document.querySelector('#fastposteditor')){
            ...
            QuickReply.targetReplyEditContent.value = this.replysCustom[0];
            QuickReply.targetReplyEditContent.style.background = 'none';
        }
    };
